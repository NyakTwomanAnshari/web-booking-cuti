  ...
  <nav class="main-header navbar navbar-expand-md">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        <ul class="navbar-nav font-weight-bold ml-auto p-3" style="background: #333;border-bottom-left-radius: 30px;border-top-left-radius: 30px;">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url().'view/cuti/users';?>" class="nav-link text-white">DAFTAR PENGAJUAN CUTI</a>
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url().'add/users/data';?>" class="nav-link text-white">PENAMBAHAN USER</a>
          </li>
          <li class="nav-item">
