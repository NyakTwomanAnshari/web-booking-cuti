...
<div class="wrapper">
  <header class="main-header">
    <?php $this->load->view('layouts/user/navbar');?>
  </header>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="text-center p-5">
              <div class="font-weight-bold info_bottom" style="font-size:16px;">Note :<br>"Jika ada kendala dalam penginputan agar menghubungi bagian umum BNI Banda Aceh"</div>
            </div>
          </div>
        </div>
    </div>
...
<?php $this->load->view('scrpt/users/dashboard');?>
<script>
    new Typed('#typed', {
